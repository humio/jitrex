...
public class UnicodeTables {
  ...
  public static final Map<String, int[][]> CATEGORIES = Categories();
  public static final Map<String, int[][]> SCRIPTS = Scripts();
  static final Map<String, int[][]> PROPERTIES = Properties();
  public static final Map<String, int[][]> FOLD_CATEGORIES = FoldCategory();
  public static final Map<String, int[][]> FOLD_SCRIPT = FoldScript();
