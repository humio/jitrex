...
import com.humio.jitrex.interp.InterpRegexFactory;
import com.humio.util.jint.util.CompilerException;
import com.humio.jitrex.util.CaseInsensitiveRegex;
...
public class Grep {
    ...
    public static void main(String[] args) {
        ...
        if (args.length == last) {
            System.err.println("Usage: java kmy.jitrex.util.Grep jitrex [ file ... ]");
            System.err.println("\tuse perl syntax for regular expressions");
            System.err.println();
            System.err.println("Options:");
            System.err.println("\t--interp            - do not compile jitrex into class (slower)");
